...
export const World3DCanvas: React.FC<World3DCanvasProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Persistent HUD Depth Status Monitor */}
      <div className="absolute bottom-3 sm:bottom-6 left-3 sm:left-6 font-label text-[9px] sm:text-[11px] text-titanium/90 tracking-wider sm:tracking-widest pointer-events-none flex items-center gap-2 bg-white/90 backdrop-blur-md px-2.5 sm:px-3.5 py-1 sm:py-1.5 border border-border-subtle rounded-full shadow-md max-w-[85vw] truncate">
